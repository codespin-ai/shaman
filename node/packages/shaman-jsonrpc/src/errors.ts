...
export function taskNotCancelable(taskId: string, state: string): JsonRpcErrorClass {
  return new JsonRpcErrorClass(
...
export function contentTypeNotSupported(contentType: string): JsonRpcErrorClass {
  return new JsonRpcErrorClass(
